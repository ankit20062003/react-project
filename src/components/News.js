...
const News = (props) => {
  ...
  const fetchMoreData = async () => {
    ...
    const url = `https://gnews.io/api/v4/top-headlines?category=${
      props.category
    }&lang=en&country=${props.country}&max=${props.pageSize}&apikey=${
      props.apiKey
    }&page=${page + 1}`;

    // const url= `https://newsapi.org/v2/top-headlines?country=de&category=business&apiKey=${props.apiKey}&page=${page+1}&max=${props.pageSize}`
